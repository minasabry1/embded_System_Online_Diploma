...
#define LCD_PORT					PORTC //Data pins of LCD connected to all portA Pins
#define LCD_Port_Direction			DDRC

#define LCD_Control					PORTD //Control pins of LCD connected PortB
